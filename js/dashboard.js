...
const RECOMMENDATIONS = {
    None: {
        ...
        verdictDesc: 'Parameter tubuhmu berada dalam rentang normal. Model AI tidak menemukan pola yang berkaitan dengan gangguan tidur.',
    ...
    Insomnia: {
        ...
        verdictDesc: 'Model AI mendeteksi pola yang konsisten dengan insomnia berdasarkan kombinasi faktor di bawah ini.',
        verdictClass: 'verdict-insomnia',
        accentColor: 'var(--sand)',
        insightPrefix: 'Faktor yang paling berkontribusi terhadap prediksi insomnia adalah',
    },
    'Sleep Apnea': {
        ...
        verdictDesc: 'Model AI mendeteksi kombinasi parameter yang berkaitan erat dengan sleep apnea. Segera konsultasikan ke tenaga medis.',
        verdictClass: 'verdict-apnea',
        accentColor: '#d98080',
        insightPrefix: 'Faktor risiko terbesar yang memicu prediksi sleep apnea adalah',
    },
};
        ...
        rawFactors = [
            {
                ...
                value: `${stress}/10`,
                weight: (10 - stress) * 9,
                suffix: stress <= 4 ? 'Sangat Rileks' : stress <= 6 ? 'Terkontrol' : 'Perlu Perhatian',
                description: stress <= 5
            ...
            },
            {
                ...
                value: `${quality}/10`,
                weight: quality * 8,
                suffix: quality >= 7 ? 'Sangat Baik' : quality >= 5 ? 'Cukup' : 'Perlu Ditingkatkan',
                description: `Kualitas tidur ${quality}/10 menunjukkan istirahat yang ${quality >= 7 ? 'berkualitas' : 'cukup memadai'}.`,
            },
            {
                name: 'Durasi Tidur',
                value: `${duration} jam`,
                weight: duration >= 7 && duration <= 9 ? 78 : Math.max(100 - Math.abs(8 - duration) * 15, 10),
                suffix: duration >= 7 && duration <= 9 ? 'Ideal' : duration < 7 ? 'Kurang' : 'Berlebih',
            ...
            },
            {
                ...
                suffix: physical >= 45 ? 'Aktif' : physical >= 20 ? 'Moderat' : 'Kurang Aktif',
            ...
            },
            {
                ...
                suffix: systolic < 130 ? 'Normal' : systolic < 140 ? 'Elevated' : 'Tinggi',
        ...
        rawFactors = [
            {
                ...
                suffix: systolic >= 130 ? 'Hipertensi' : systolic >= 125 ? 'Elevated' : 'Borderline',
            ...
            },
            {
                ...
                value: bmi,
                weight: bmiRisk,
                suffix: bmi === 'Obese' ? 'Risiko Tinggi' : bmi === 'Overweight' ? 'Risiko Sedang' : 'Risiko Rendah',
            ...
            },
            {
                ...
                suffix: quality <= 4 ? 'Sangat Buruk' : quality <= 6 ? 'Buruk' : 'Moderat',
            ...
            },
            {
                ...
                value: `${stress}/10`,
                weight: stress * 7.5,
                suffix: stress >= 7 ? 'Beban Tinggi' : stress >= 5 ? 'Moderat' : 'Terkontrol',
        ...
        rawFactors = [
            {
                ...
                value: `${stress}/10`,
                weight: stress * 9,
                suffix: stress >= 7 ? 'Pemicu Utama' : stress >= 5 ? 'Berkontribusi' : 'Moderat',
            ...
            },
            {
                ...
                suffix: quality <= 4 ? 'Sangat Buruk' : quality <= 6 ? 'Terganggu' : 'Moderat',
            ...
            },
            {
                ...
                suffix: duration < 6 ? 'Sangat Kurang' : duration < 7 ? 'Kurang' : 'Cukup',
            ...
            },
            {
                ...
                suffix: physical < 20 ? 'Sangat Kurang' : physical < 40 ? 'Kurang' : 'Moderat',
...
function renderResult(result, data) {
    ...
    document.getElementById('res-tips').innerHTML = rec.tips.map(t => '<li>' + t + '</li>').join('');
    ...
    const othersSum  = Math.round(factors.slice(3).reduce((s, f) => s + Math.min(Math.max(f.weight, 5), 95), 0) / Math.max(factors.slice(3).length, 1));
    ...
    document.getElementById('xai-others-pct').textContent = othersDisplay + '% kontribusi rata-rata';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        var requiredFields = [
            ...
            'bmi', 'systolic', 'diastolic', 'heart_rate', 'daily_steps',
        ];
        ...
        try {
            ...
            alert('Gagal terhubung ke model AI. Pastikan file app.py sedang berjalan di terminal.');
        } finally {
